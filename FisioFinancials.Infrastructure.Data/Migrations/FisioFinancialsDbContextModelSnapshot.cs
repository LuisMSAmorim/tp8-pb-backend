...
namespace FisioFinancials.Infrastructure.Data.Migrations
{
    ...
    partial class FisioFinancialsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FisioFinancials.Domain.Model.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("FisioFinancials.Domain.Model.Entities.Received", b =>
                {
                    b.HasOne("FisioFinancials.Domain.Model.Entities.User", "User")
                        .WithMany("Receiveds")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FisioFinancials.Domain.Model.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
